...
namespace tira {
    ...
    public:
        // ctor/dtor
        icosahedron(T radius = 1.0f) : interleavedStride(32) {
            setRadius(radius);
        }
        ~icosahedron() {}
        ...
        T getEdgeLength() const { return edgeLength; }

        void setEdgeLength(T edge) {
        ...
        const T* getVertices() const { return vertices.data(); }
        const T* getNormals() const { return normals.data(); }
        const T* getTexCoords() const { return texCoords.data(); }
        ...
        const T* getInterleavedVertices() const { return interleavedVertices.data(); }

        // draw in VertexArray mode
        void draw() const;
        void drawLines(const T lineColor[4]) const;
        void drawWithLines(const T lineColor[4]) const;
    ...
    private:
        // static functions
        static void computeFaceNormal(T v1[3], T v2[3], T v3[3], T n[3]) {
        ...
        void addVertices(T v1[3], T v2[3], T v3[3]) {
        ...
        void addNormals(T n1[3], T n2[3], T n3[3]) {
        ...
        void addTexCoords(T t1[2], T t2[2], T t3[2]) {
        ...
        // interleaved
        std::vector<T> interleavedVertices;
