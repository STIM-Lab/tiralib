...
public:
	...
	void focal_length(float distance){_focus = distance;}
	void fov(float field_of_view) { _fov = field_of_view; }
	...
	void lookat(glm::vec3 pos, glm::vec3 new_up){_up = new_up; lookat(pos);}
	...
	void orbit(float theta_x, float theta_y) {
